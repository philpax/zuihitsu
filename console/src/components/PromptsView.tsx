  ...
  return (
    <>
      ...
      <textarea
        ...
        rows={18}
        spellCheck={false}
        className="w-full resize-y rounded-xs border border-line bg-paper/60 p-3 font-mono text-xs leading-relaxed text-ink focus:border-ink-faint focus:outline-none"
      />
