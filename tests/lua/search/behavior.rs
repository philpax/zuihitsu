//! The search behaviour itself: recall of an indexed entry, the date and salient relations a hit
//! carries, old-name recall, print/return surfacing, and the hit-as-handle affordances (rendering,
