//! Eval-crate types: the eval-package schema — the JSON contract between the harness and the viewer.

use serde::{Deserialize, Serialize};
use zuihitsu_core::{event::EventPayload, model::Usage};
...
pub struct RunRecord {
    ...
    #[cfg_attr(feature = "ts", ts(type = "number"))]
    pub finished_at_ms: i64,
    pub events: Vec<zuihitsu_core::event::Event>,
