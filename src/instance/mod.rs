...
impl Instance {
    ...
    /// Drive the consolidation pass on demand — the CLI/console entry point. Returns how many effects
    /// were committed. Unlike the timer driver (which resumes from the incremental cursor), the manual
    ...
    /// Drive the canonical-profile pass on demand. Returns how many effects were committed. Sweeps from
    ...
    /// Drive the link-redundant entry cleanup pass on demand. Returns how many effects were committed.
